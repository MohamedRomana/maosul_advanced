        ...
        return Column(
          ...
          children: [
            ...
            AppInput(
              ...
              top: 10.h,
              hint: 'سجل ملاحظاتك',
              controller: context.read<StoreOrderCubit>().noteController,
              bottom: 24.h,
            ),
            AppText(
              top: 16.h,
                ...
                children: [
                  Row(
                    children: [
                      ...
                      AppText(
                        text:
                            '${context.read<StoreOrderCubit>().orderData?.totalBeforePromo} ر.س',
                        size: 14.sp,
                        fontWeight: FontWeight.w600,
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      AppText(
                        text:
                            '${context.read<StoreOrderCubit>().orderData?.valueAdded} ر.س',
                        size: 14.sp,
                        fontWeight: FontWeight.w600,
                      ),
                    ],
                  ...
                  Row(
                    children: [
                      ...
                      AppText(
                        text:
                            '${context.read<StoreOrderCubit>().orderData?.totalAfterPromo} ر.س',
                        size: 18.sp,
