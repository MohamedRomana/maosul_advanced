...
class _OtpApiService implements OtpApiService {
  ...
  Future<OtpResponseModel> sendOtp(
    ...
    _data.addAll(otpRequestBodyModel.toJson());
    final _options = _setStreamType<OtpResponseModel>(
    ...
    late OtpResponseModel _value;
    try {
      _value = OtpResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
